                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-24 mb-16">
                    ...
                    <div>
                        ...
                        <p className="text-[#7D7D7D] font-sans text-base leading-relaxed max-w-sm mb-6">
                            GiftByDeesh creates thoughtfully curated and customizable gift boxes to make every special moment unforgettable. Crafted with love, delivered with care.
                        </p>
                        <img src={logo} alt="GiftByDeesh Logo" className="h-25 w-auto object-contain mix-blend-multiply" />
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col gap-2 mt-4">
                                {['Terms & Conditions', 'Shipping', 'Returns & Cancellations', 'Privacy Policy'].map((item, index) => (
                                    <a
                                        key={index}
                                        href="#"
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            {/* Instagram */}
                            <a href="#" className="w-10 h-10 rounded-full border border-[#D6737B] flex items-center justify-center text-[#D6737B] hover:bg-[#D6737B] hover:text-white transition-all duration-300 group">
